...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      'data-[state=checked]:bg-[var(--color-accent-fill)] data-[state=unchecked]:bg-[var(--color-border-strong)]',
      className,
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        ...
        '[dir=rtl]_&:data-[state=checked]:-translate-x-4 [dir=rtl]_&:data-[state=unchecked]:-translate-x-0.5',
      )}
    />
  </SwitchPrimitive.Root>
));
